...
# st.dataframe(df_visualizar, use_container_width=True)  # este código exibe a visualização da tabela

# Criando o layout da aplicação
tab0, tab1, tab2, tab3, tab4 = st.tabs(['Geral', 'Etnia', 'Gênero', 'Desempenho notas', 'Desempenho em matérias'])
...
with tab1:
    ...
    Analisando o grupo de etnias de estudantes o grupo C representa a maior proporção dos estudantes, representando 31,9% do total.
...
with tab4:
    ...
    st.write('### Analise de desempenho de notas por disciplina')
